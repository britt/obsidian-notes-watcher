...
Build Note Watcher, a Python daemon that detects @ mentions in Obsidian notes, dispatches instructions to AI agents, and writes its response as an HTML comment. Supports both real-time daemon mode and batch GitHub Action mode.
...
- [x] Responses should not be inserted inline but should be inserted as part of the @done comment
- [x] README daemon example should show dispatching instructions to claude code
- [x] README Github example should show dispatching instructions to claude code
- [x] README Github example should link to Claude Code Github action docs
